...
jQuery(document).ready(function() {	
	...
	// submerchant logic for merchant-signup-info page
  function set_defaults(sel_val)
  {
    if(sel_val == "PERSONAL")
    {
      /*$("#contact-name").show();
      $("#contact-surname").show(); */
      $("#identity-number").show();  
      $("#tax-office").hide();
      $("#legal-company-title").hide();
      $("#tax-number").hide();
    }
    else if(sel_val == "PRIVATE_COMPANY")
    {
      /*$("#contact-name").hide();
      $("#contact-surname").hide(); */
      $("#tax-office").show();
      $("#legal-company-title").show();
      $("#identity-number").show();
      $("#tax-number").hide();
    }
    else if(sel_val == "LIMITED_OR_JOINT_STOCK_COMPANY")
    {
      /*$("#contact-name").hide();
      $("#contact-surname").hide(); */
      $("#tax-office").show();
      $("#legal-company-title").show();
      $("#tax-number").show();
      $("#identity-number").hide();
    }
  }
  
  $('#submerchant_type').on('change', function() {
    set_defaults(this.value);            
  })
  // submerchant logic ends
});	
...
{
    window.open('tel:' + phone_number,'height:500,width:500');
    return false;
}
...
class StoreController extends CController
{
	...
	{		
		...
		$act_menu=FunctionsV3::getTopMenuActivated();e
	...
	public function actioniyzipayInit()
	{
		$this->render('iyzipay-init');
	}
	
	public function actioniyzipayreturn()
	{
		echo "in";exit;
    $this->render('iyzipay-return');
	}
	
	
	public function actionmerchantsignupstep3c()
	{
		$this->render('merchant-signup-step3c');
	}

	...
	*/
    ...
    {    	    	
	    ...
	    if (in_array($action_name,(array)$menu_list)){	    	
	    	if (!in_array($action_name,(array)$aa_access)  && $action_name!='iyzicosettings'){	 	    		
	...
	public function actionIyzicoSettings()
	{
		$this->crumbsTitle=Yii::t("default","Iyzico Settings");
		$this->render('iyzico-settings');
	}

...
//dump($params); die();
		...
		public function saveAdminiyzipaySettings()
		{			
		    Yii::app()->functions->updateOptionAdmin("admin_enabled_iyzipay",
	    	isset($this->data['admin_enabled_iyzipay'])?$this->data['admin_enabled_iyzipay']:'');
	    	
	    	Yii::app()->functions->updateOptionAdmin("admin_iyzipay_mode",
	    	isset($this->data['admin_iyzipay_mode'])?$this->data['admin_iyzipay_mode']:'' );
	    	
	    	Yii::app()->functions->updateOptionAdmin("admin_iyzipay_form_style",
	    	isset($this->data['admin_iyzipay_form_style'])?$this->data['admin_iyzipay_form_style']:'' );
	    	
	    	Yii::app()->functions->updateOptionAdmin("admin_sanbox_iyzipay_api_key",
	    	isset($this->data['admin_sanbox_iyzipay_api_key'])?$this->data['admin_sanbox_iyzipay_api_key']:'' );
	    	
	    	Yii::app()->functions->updateOptionAdmin("admin_sanbox_iyzipay_secret_key",
	    	isset($this->data['admin_sanbox_iyzipay_secret_key'])?$this->data['admin_sanbox_iyzipay_secret_key']:'' );
	    	
	    	Yii::app()->functions->updateOptionAdmin("iyzipay_submerchant_key",
	    	isset($this->data['iyzipay_submerchant_key'])?$this->data['iyzipay_submerchant_key']:'' );
		...
		{						
			...
			if (isset($this->data['payment_opt'])){
				...
				} elseif($this->data['payment_opt']=="iyzipay"){ /*IYZIPAY added by lexcis this elseif condition*/
					 $this->code=1;                      
                      $this->msg=Yii::t("default","Please wait while we redirect you to iyzipay");
...
$country=array_key_exists($val['country_code'],(array)$country_list)?$country_list[$val['country_code']]:$val['country_code'];
		...
		{						
	    	...
	    	/* Netgsm */
	    	Yii::app()->functions->updateOptionAdmin("netgsm_user",
	    	isset($this->data['netgsm_user'])?$this->data['netgsm_user']:'');
	    	
	    	Yii::app()->functions->updateOptionAdmin("netgsm_password",
	    	isset($this->data['netgsm_password'])?$this->data['netgsm_password']:'');
	    	
	    	Yii::app()->functions->updateOptionAdmin("netgsm_header",
	    	isset($this->data['netgsm_header'])?$this->data['netgsm_header']:'');

		...
		return array(  
		    ...
		    'items'=>array(
                ...
                'label'=>'<i class="fa fa-usd"></i>'.Yii::t("default",'Payment Gateway'),
                   ...
                   array('visible'=>true,
                   'tag'=>'iyzicoSettings','label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Iyzico"), 
                   'url'=>array('admin/iyzicoSettings')),
...
$menu_html.="</li>";
    ...
    public function sendSMS($to='',$message='' , $record_id='')
    {
    	...
    	switch ($sms_provider) {
          ...
          $h = getOptionA('netgsm_header');
          $header = html_entity_decode($h, ENT_COMPAT, "UTF-8"); 
          $header = rawurlencode($header); 
          
          $user = getOptionA('netgsm_user');
          $pass = getOptionA('netgsm_password');
          
          $language = strtoupper(Yii::app()->language);
          $to = str_replace('+','',$to);
          
        	$url="http://api.netgsm.com.tr/bulkhttppost.asp?usercode=$user&password=$pass&gsmno=$to&message=$msg&msgheader=$header&startdate=$startdate&stopdate=$stopdate&language=$language";
        	//echo $url;
    ...
    public function getMerchantListOfPaymentGateway()
    {
		...
		if (!empty($paymentgateway)){
			...
			if ( $db_ext->rst($stmt)){
			   ...
			   $paymentgateway=array('pyp','stp','mcd','ide','payu','pys','iyzipay');
			}
		}
   ...
   {    	
    ...
    public function getiyzipayConnection($merchant_id='')
    {
    	 $iyzipay_mode=yii::app()->functions->getOption('iyzipay_mode',$merchant_id);    	 
		 $iyzipay_con=array();		 
		 if ($iyzipay_mode=="sandbox"){
		  	  $iyzipay_con['mode']="sandbox";
		  	  //$iyzipay_con['sandbox']['paypal_nvp']='https://api-3t.sandbox.paypal.com/nvp';
		  	  $iyzipay_con['sandbox']['iyzipay_web']='https://sandbox-api.iyzipay.com';
		  	  $iyzipay_con['sandbox']['api_key']=yii::app()->functions->getOption('sanbox_iyzipay_api_key',$merchant_id);
		  	  $iyzipay_con['sandbox']['secret_key']=yii::app()->functions->getOption('sanbox_iyzipay_secret_key',$merchant_id);
		  	/*  $iyzipay_con['sandbox']['signature']=yii::app()->functions->getOption('sanbox_paypal_signature',$merchant_id);
		  	  $iyzipay_con['sandbox']['version']='61.0';
		  	  $iyzipay_con['sandbox']['action']='Sale';*/
		  } else {
		  	  $iyzipay_con['mode']="live";
		  	  //$iyzipay_con['live']['paypal_nvp']='https://api-3t.paypal.com/nvp';
		  	   $iyzipay_con['sandbox']['iyzipay_web']='https://api.iyzipay.com';
		  	  $iyzipay_con['sandbox']['api_key']=yii::app()->functions->getOption('sanbox_iyzipay_api_key',$merchant_id);
		  	  $iyzipay_con['sandbox']['secret_key']=yii::app()->functions->getOption('sanbox_iyzipay_secret_key',$merchant_id);
		  	 /* $iyzipay_con['live']['signature']=yii::app()->functions->getOption('live_paypal_signature',$merchant_id);
		  	  $iyzipay_con['live']['version']='61.0';
		  	  $iyzipay_con['live']['action']='Sale';*/
		  }
		  return $iyzipay_con;
    }	
    
    public function getiyzipayConnectionAdmin()
   {
    	 $iyzipay_mode=yii::app()->functions->getOptionAdmin('admin_iyzipay_mode');    	     	 
		 $iyzipay_con=array();		 
		 if ($iyzipay_mode=="sandbox"){
		  	  $iyzipay_con['mode']="sandbox";
		  	//  $iyzipay_con['sandbox']['paypal_nvp']='https://api-3t.sandbox.paypal.com/nvp';
		  	  $iyzipay_con['sandbox']['iyzipay_web']='https://sandbox-api.iyzipay.com';
		  	  $iyzipay_con['sandbox']['api_key']=yii::app()->functions->getOptionAdmin('admin_sanbox_iyzipay_api_key');
		  	  $iyzipay_con['sandbox']['secret_key']=yii::app()->functions->getOptionAdmin('admin_sanbox_iyzipay_secret_key');
		  	  /*$iyzipay_con['sandbox']['signature']=yii::app()->functions->getOptionAdmin('admin_sanbox_paypal_signature');
		  	  $iyzipay_con['sandbox']['version']='61.0';
		  	  $iyzipay_con['sandbox']['action']='Sale';*/
		  } else {
		  	  $iyzipay_con['mode']="live";
		  	//  $iyzipay_con['live']['paypal_nvp']='https://api-3t.paypal.com/nvp';
		  	  $iyzipay_con['live']['iyzipay_web']='https://api.iyzipay.com';
		  	  $iyzipay_con['live']['api_key']=yii::app()->functions->getOptionAdmin('admin_sanbox_iyzipay_api_key');
		  	  $iyzipay_con['live']['secret_key']=yii::app()->functions->getOptionAdmin('admin_sanbox_iyzipay_secret_key');
		  	  /*$iyzipay_con['live']['signature']=yii::app()->functions->getOptionAdmin('admin_live_paypal_signature');
		  	  $iyzipay_con['live']['version']='61.0';
		  	  $iyzipay_con['live']['action']='Sale';*/
		  }
		  return $iyzipay_con;

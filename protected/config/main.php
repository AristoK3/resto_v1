...
$patern.="|iyzipayinit|merchantsignupstep3c|iyzipayreturn";
...
return array(
	...
	'components'=>array(		   
		...
		'db'=>array(	        
		    'class'            => 'CDbConnection' ,
			'connectionString' => 'mysql:host=localhost;dbname=new_upsa',
			'emulatePrepare'   => true,
			'username'         => 'yemeksiparisi',
			'password'         => '+J$*3Jb9tiN9XA%xwX345',
			'charset'          => 'utf8',
			'tablePrefix'      => 'mt_',
	    ),			

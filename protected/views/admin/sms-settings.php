...
<li class="<?php echo $provider_selected=="netgsm"?"uk-active":"";?>" ><a href="#"><?php echo t("Netgsm")?></a></li>
</ul>
...
<div class="uk-form-row">
  ...
  <?php
  echo CHtml::radioButton('sms_provider',
$provider_selected=="netgsm"?true:false
,array(
'class'=>"icheck",
'value'=>'netgsm'
));
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","API username")?></label>
  <?php 
  echo CHtml::textField('netgsm_user',
  Yii::app()->functions->getOptionAdmin('netgsm_user')
  ,array(
    'class'=>"uk-form-width-large"    
  ))
  ?>
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","API password")?></label>
  <?php 
  echo CHtml::textField('netgsm_password',
  Yii::app()->functions->getOptionAdmin('netgsm_password')
  ,array(
    'class'=>"uk-form-width-large"    
  ))
  ?>
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Header")?></label>
  <?php 
  echo CHtml::textField('netgsm_header',
  Yii::app()->functions->getOptionAdmin('netgsm_header')
  ,array(
    'class'=>"uk-form-width-large"    
  ))
  ?>

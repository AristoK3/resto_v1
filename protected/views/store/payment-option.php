	       ...
	       <div class="order-list-wrap">   
            ...
            ?>
             ...
             <?php endif;?>          
	          ...
	          <a href="javascript:;" id="place_order_button" class="place_order green-button medium inline block">
	          <?php echo t("Place Order")?>
	          </a>
	          <br>
	          <a href="tel://<?php echo $merchant_info['contact_phone'];?>" id="call_button" class="green-button medium inline block">
	          <i class="fa fa-phone"></i>&nbsp;&nbsp;<?php echo t("Call Restaurant")?> : <?php echo $merchant_info['contact_phone'];?>
	          </a>
